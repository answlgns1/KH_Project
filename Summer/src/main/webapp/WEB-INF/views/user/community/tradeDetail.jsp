				...
				<div class="row row-pb-md">
					...
					<div style="border : 1px solid lightgrey; padding : 10px; margin-bottom : 10px;">
						<table style="width:100%;">
							<tr>
								<td><h2>${trade.BTITLE}</h2></td>
							</tr>
							<tr>
								<td>${trade.WRITER} ${trade.MEMBERSHIP}</td>
							</tr>
							<tr>
								<td>${trdae.BDATE2CHAR}</td><td style="text-align: right; width:100px;">댓글 ${trade.COMMENTCOUNT}</td><td style="text-align: right; width:100px;">조회 ${trade.VIEWS}</td>
							</tr>
						</table>
					...
					<button type="button" class="btn btn-primary thema" style="float : right;"
							onclick="location.href='${pageContext.request.contextPath}/community/selectFreeList.do';">목록ㅁㅁ</button>
					ㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹㄹ
					</div>
				</div>
