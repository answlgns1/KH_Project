			...
			<div class="container">
				<div class="row row-pb-md">
					<div class="col" >
						...
						<!-- 폼 시작 -->
							<form id="tradeBoard" action="${pageContext.request.contextPath}/community/insertTradeEnd.do" method="post" onsubmit="return fn_submit();" enctype="multipart/form-data">
								<!-- 게시글정보 시작 -->
	...
	<script>
		...
		function fn_cancel() {
			if(confirm('작성 취소하시겠습니까?')) {
				location.href='${pageContext.request.contextPath}/community/selectTradeList.do?';
			}
		}
